...
void optimisedrandompoints(int N)
{
    std::vector<point> data;
    data.reserve(N);
...
void optimisedwraprandompoints(int N)
{
    std::vector<point> data;
    data.reserve(N);
...
void optimisedwrapcsvpoints(int N)
{
    std::vector<point> data;
    std::string csv = std::to_string(N) + " locations.csv";
    std::ifstream infile(csv);
...
void optimisedparallelrandompoints(int N) 
{
    std::vector<point> data;
    data.reserve(N);
...
void optimisedparallelwraprandompoints(int N)
{
    std::vector<point> data;
    data.reserve(N);
...
void optimisedparallelwrapcsvpoints(int N)
{
    std::vector<point> data;
    std::string csv = std::to_string(N) + " locations.csv";
    std::ifstream infile(csv);
